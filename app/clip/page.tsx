...
export default function ClipIQPage() {
  ...
  return <main className="min-h-screen bg-[#050505] text-white px-4 py-8 md:px-8"><div className="max-w-5xl mx-auto">
    <header className="mb-8"><p className="text-xs font-black tracking-[0.25em] text-red-500">CLIP IQ</p><h1 className="text-5xl md:text-6xl font-black mt-2">GAMEPLAY REVIEW</h1><p className="text-zinc-500 mt-3 max-w-2xl">Submit up to three gameplay clips every 24 hours. Recruiters are the only other users who can view them.</p></header>
